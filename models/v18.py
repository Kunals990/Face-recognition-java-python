        ...
        while True:
            ...
            # Bounding Box
                    ...
                    if conf > confidence:
                        ...
                        #         cv2.putText(img, 'Attendance Marked', (x1 + 6, y1 -30), cv2.FONT_HERSHEY_COMPLEX, 1, (255, 0, 0),2)  # Change color to blue
...
webcam_thread = threading.Thread(target=start_loop)
webcam_thread.start()
...
stop_thread = threading.Thread(target=stop_webcam)
stop_thread.start()
