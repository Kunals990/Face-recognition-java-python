...
def webcam_loop(confidence, yolo_classNames, marked_attendance, command_queue):
    prev_frame_time = 0
    model = YOLO("C://Users//hp//Documents//Python//Face Recognition//models//best.pt")
    cap = cv2.VideoCapture(0)  # For Webcam
    cap.set(3, 480)
    cap.set(4, 480)
    # model.load("C://Users//hp//Documents//Python//Face Recognition//models//best.pt")
    new_frame_time = 0
    while True:
...
webcam_thread = threading.Thread(target=webcam_loop,
                                     args=(confidence, yolo_classNames, marked_attendance, command_queue))
webcam_thread.start()
...
while True:
    ...
    if command.lower() == "1":
        ...
        webcam_loop(confidence, yolo_classNames, marked_attendance, command_queue)
    elif (command=="2" ):
